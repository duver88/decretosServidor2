                            ...
                            <div class="space-y-3">
                                @forelse($categories as $category)
                                    @php
                                        ...
                                        $canCreate = $categoryPerms['can_create'] ?? false;
                                        $canEdit = $categoryPerms['can_edit'] ?? false;
                                        $canDelete = $categoryPerms['can_delete'] ?? false;
                                    @endphp
                                        ...
                                        <div class="flex flex-wrap gap-4">
                                            <label class="flex items-center cursor-pointer">
                                                <input type="checkbox"
                                                       ...
                                                       value="1"
                                                       {{ old("category_permissions.{$category->id}.can_create", $canCreate) ? 'checked' : '' }}
                                            ...
                                            <label class="flex items-center cursor-pointer">
                                                <input type="checkbox"
                                                       ...
                                                       value="1"
                                                       {{ old("category_permissions.{$category->id}.can_edit", $canEdit) ? 'checked' : '' }}
                                            ...
                                            <label class="flex items-center cursor-pointer">
                                                <input type="checkbox"
                                                       ...
                                                       value="1"
                                                       {{ old("category_permissions.{$category->id}.can_delete", $canDelete) ? 'checked' : '' }}
